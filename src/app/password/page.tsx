	...
	return (
		<>
			<main className="back3 relative w-full h-screen">
				...
				<div className="mt-52 bg-default-white mx-auto w-[20%] rounded-lg h-[30px] justify-center items-center text-center text-xl lg:shadow-[rgba(50,50,93,0.25)_0px_6px_12px_-2px,_rgba(0,0,0,0.3)_0px_3px_7px_-3px] text-primary font-bold m-6">
					<h1 className="text-xl text-primary font-bold">Gestione su contraseña de correo:</h1>
				</div>
				<div
				...
				<div className="justify-center text-center h-[90px]">
					<button
						className="mx-5 mt-[30px] w-[7%] min-w-[70px] max-w-xs h-12 font-semibold bg-default-white border-2 rounded-lg border-primary text-primary  hover:text-default-white hover:bg-primary"
						onClick={() => router.push("/")}
					>
						Volver
					</button>
